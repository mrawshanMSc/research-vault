...
const tabsListVariants = cva(
  "group/tabs-list text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col border-border inline-flex w-fit items-center justify-center rounded-lg border p-[3px] data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "after:bg-foreground group-data-horizontal/tabs:after:inset-x-0 group-data-horizontal/tabs:after:-bottom-1.25 group-data-horizontal/tabs:after:h-0.5 group-data-vertical/tabs:after:inset-y-0 group-data-vertical/tabs:after:-right-1 group-data-vertical/tabs:after:w-0.5 group-data-[variant=line]/tabs-list:data-active:after:opacity-100 after:absolute after:opacity-0 after:transition-opacity",
        className
      )}
      {...props}
    />
